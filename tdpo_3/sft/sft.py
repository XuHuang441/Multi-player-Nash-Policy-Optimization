...
class ScriptArguments:
    ...
    # /apdcephfs_us/share_300814644/data/nlp/huggingface_models/meta-llama/Llama-2-7b-hf (Meta-Llama-3-8B)
    model_name: Optional[str] = field(
        default="/apdcephfs_us/share_300814644/data/nlp/huggingface_models/meta-llama/Meta-Llama-3-8B",
        metadata={
    ...
    output_dir: Optional[str] = field(default="./models/sft_model_gemma")
...
# change flash attention to false, flash attention only for A100
# change torch.bfloat16 to torch.float16
